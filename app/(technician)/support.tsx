...
export default function TechnicianSupportScreen() {
  const { user } = useAuth();
  const { getUserTickets, updateTicketStatus, isLoading, refreshData } = useData();
  const [selectedStatus, setSelectedStatus] = useState<TicketStatus | 'all'>('in_progress');
      ...
      <LinearGradient colors={['#7C3AED', '#A855F7']} style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <View>
            ...
            <Text style={styles.headerSubtitle}>{counts.total} assigned tickets</Text>
          </View>
        </View>
      </LinearGradient>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.statusOptions}>
              ...
              >
                <CheckCircle size={20} color={newStatus === 'resolved' ? '#FFFFFF' : '#22C55E'} />
                <View style={styles.statusOptionContent}>
                  <Text style={[styles.statusOptionText, newStatus === 'resolved' && styles.statusOptionTextSelected]}>
                    Mark as Resolved
                  </Text>
                  <Text style={[styles.statusOptionSubtext, newStatus === 'resolved' && styles.statusOptionTextSelected]}>
              ...
              >
                ...
                <View style={styles.statusOptionContent}>
                  ...
                  <Text style={[styles.statusOptionSubtext, newStatus === 'in_progress' && styles.statusOptionTextSelected]}>

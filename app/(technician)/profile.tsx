...
export default function TechnicianProfileScreen() {
  ...
  const todayLeads = myLeads.filter(lead => {
    ...
    return today === leadDate && lead.technician_id === user.id;
  });

  const completedInstallations = myLeads.filter(l => l.status === 'completed' && l.technician_id === user.id);
      ...
      <LinearGradient colors={['#059669', '#10B981']} style={styles.header}>
        <View style={styles.profileHeader}>
          ...
          <View style={styles.profileInfo}>
            ...
            <Text style={styles.userSpecialization}>{(user as any).specialization || 'Solar Installation Specialist'}</Text>
          </View>
        </View>
      </LinearGradient>
        ...
        <View style={styles.statsContainer}>
          ...
          <View style={styles.statsGrid}>
            ...
            <View style={styles.statCard}>
              ...
              <Text style={styles.statNumber}>{myLeads.filter(l => l.status === 'transit').length}</Text>
        ...
        <View style={styles.performanceContainer}>
          ...
          <View style={styles.metricCard}>
            <View style={styles.metricHeader}>
              ...
              <Text style={styles.metricTitle}>Installation Work</Text>
            </View>
            <View style={styles.metricStats}>
              <View style={styles.metricStat}>
                <Text style={styles.metricNumber}>{myLeads.length}</Text>
                <Text style={styles.metricLabel}>Total Visits</Text>
              </View>
              <View style={styles.metricStat}>
                <Text style={styles.metricNumber}>{completedInstallations.length}</Text>
                <Text style={styles.metricLabel}>Completed</Text>
              </View>
              <View style={styles.metricStat}>
                <Text style={[styles.metricNumber, { color: '#10B981' }]}>
                  {myLeads.length > 0 
                    ? ((completedInstallations.length / myLeads.length) * 100).toFixed(1)
                    : '0'}%
                </Text>
          ...
          <View style={styles.metricCard}>
            <View style={styles.metricHeader}>
              ...
              <Text style={styles.metricTitle}>Support Services</Text>
            </View>
            <View style={styles.metricStats}>
              <View style={styles.metricStat}>
        ...
        <View style={styles.skillsContainer}>
          ...
          <View style={styles.skillsGrid}>
            <View style={styles.skillBadge}>
              <Text style={styles.skillText}>Residential Solar</Text>
            </View>
            <View style={styles.skillBadge}>
              <Text style={styles.skillText}>Commercial Systems</Text>
            </View>
            <View style={styles.skillBadge}>
              <Text style={styles.skillText}>Battery Storage</Text>
            </View>
            <View style={styles.skillBadge}>
              <Text style={styles.skillText}>System Maintenance</Text>
            </View>
          </View>
        </View>
